...
\section{Case study}
	...
	\subsection{Unpolarised Dicke states}
		...
		\begin{frame}
			...
			\begin{enumerate}
				\item<1-> 3 operators $\color{blue}\{J_x^2,J_y^2,J_z^2\}$; Constraint $\Rightarrow\expect{J_x^2}=\expect{J_y^2}$.
		...
		\begin{frame}
			...
			\begin{itemize}
				\item For that large system we use \emph{\color{blue} extrapolation methods}.
			\end{itemize}
		\end{frame}
