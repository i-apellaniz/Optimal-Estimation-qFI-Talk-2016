...
\section{Case study}
	...
	\subsection{Spin-squeezed states}
		...
		\begin{frame}
			...
			\end{figure}
			{\color{blue} Left}: For $\varian{J_x}<1.5$ it almost coincides with the P-S bound $F_Q\geq \expect{J_z}^2/\varian{J_x}$. {\color{blue} Right}: The measurement of $\expect{J_x^4}$ improve the bound.
		...
		\begin{frame}
			...
			\begin{itemize}
				\item Starting from small systems, and assuming bosonic symmetry.
				\vspace{5px}
